...
import 'package:base_bloc_3/common/widgets/swiper/src/transformer_page_view/index_controller.dart';

///
/// NOTICE::
///
/// In order to make package smaller,currently we're not supporting any build-in pages transformers
...
class TransformerPageView extends StatefulWidget {
  ...
  /// Set to false to disable pages snapping, useful for custom scroll behavior.
  /// Same as [PageView.pageSnapping]
  final bool pageSnapping;

  /// Called whenever the pages in the center of the viewport changes.
  /// Same as [PageView.onPageChanged]
  final ValueChanged<int>? onPageChanged;

  final IndexedWidgetBuilder? itemBuilder;

  // See [IndexController.model],[IndexController.next],[IndexController.previous]
  ...
  /// Set true to open infinity loop model.
  final bool loop;
  ...
  /// Creates a scrollable list that works pages by pages using widgets that are
  /// created on demand.
  ///
  /// This constructor is appropriate for pages views with a large (or infinite)
